...
public class McElieceImpl extends NativeResource {
    ...
    private static long initContext(String parameterSet) {
        ...
        return CryptoNative.mcelieceCreateContext(parameterSet);
    }
    ...
    public byte[][] encapsulate() {
        ...
        try {
            return CryptoNative.mcelieceEncapsulate(nativeContext);
        } catch (Exception e) {
            throw new IllegalStateException("Classic McEliece encapsulation failed: " + e.getMessage(), e);
        }
    }
    ...
    public byte[] decapsulate(byte[] ciphertext) {
        ...
        try {
            return CryptoNative.mcelieceDecapsulate(nativeContext, ciphertext);
        } catch (Exception e) {
            throw new IllegalStateException("Classic McEliece decapsulation failed: " + e.getMessage(), e);
        }
    }
}
